package sp.utils.datastructure;
...
public class ListUtil {
    public static void main(String[] args) throws IOException {
        ArrayList<Grade_List> al = new ArrayList<>();
        ...
        try {
            ...
            while ((str = in.readLine()) != null) {
                ...
                Grade_List g = new Grade_List(words[0],Integer.parseInt(words[1]),Integer.parseInt(words[2]),Integer.parseInt(words[3]));
                al.add(g);
            }
            in.close();
            ////////////////////////////////////////////////////////////////
        ...
        while (true)
        {
            ...
            Iterator<Grade_List> itr = al.iterator();
            while (itr.hasNext()) {
                Grade_List val = itr.next();
...
class Grade_List
{
    ...
    public Grade_List(String str, int k, int e, int m)
    {
        strName = str;
        Korean = k;
        English = e;
